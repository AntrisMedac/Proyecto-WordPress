...
get_header(); ?>
        ...
        <div class="nsl-container nsl-container-block nsl-container-login-layout-below-separator" style="display: block;">
            <a href="***?loginSocial=google" rel="nofollow" data-plugin="nsl" data-action="connect" data-provider="google">
                <span class="nsl-button nsl-button-default nsl-button-google">
                ...
                <span style="font-size: 72px;">Continuar con <b>Google</b></span>
            </span>
        </a>
    </div>
